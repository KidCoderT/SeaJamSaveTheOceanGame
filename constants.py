...
score_background_image = scale_image(pygame.image.load("assets/ui/score_bg.png"), 0.4)
...
shop_size_item = [
    [scale_image(pygame.image.load("assets/shop/boat_size/Lv1.png"), 0.18), 120],
    [scale_image(pygame.image.load("assets/shop/boat_size/Lv2.png"), 0.18), 200],
    [scale_image(pygame.image.load("assets/shop/boat_size/Lv3.png"), 0.18), 250],
    [scale_image(pygame.image.load("assets/shop/boat_size/Lv4.png"), 0.18), 300],
    [scale_image(pygame.image.load("assets/shop/boat_size/Lv5.png"), 0.18), 0]
]
...
pause_image = pygame.image.load("assets/ui/pause.png")
...
lives_background_image = scale_image(pygame.image.load("assets/ui/lives bg.png"), 0.4)
